                ...
                <div className="text-left space-y-8">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-4 min-h-[160px] md:min-h-[220px]">
                            Your Wealth, <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-600 dark:from-neon-emerald dark:to-neon-blue text-glow block mt-2">
                ...
                >
                    <div className="relative w-64 h-64 md:w-80 md:h-80">
                        <motion.div
                            ...
                            className="absolute inset-0 rounded-full border border-gray-200 dark:border-white/10 border-t-emerald-500 dark:border-t-neon-emerald border-b-blue-500 dark:border-b-neon-blue shadow-[0_0_30px_rgba(16, 185, 129, 0.2)]"
                        >
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute inset-[20px] rounded-full border border-gray-100 dark:border-white/5 border-l-emerald-500 dark:border-l-neon-emerald border-r-emerald-500 dark:border-r-neon-emerald"
                        >
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute top-1/4 left-1/4 p-4 glass-panel rounded-lg border-l-4 border-l-emerald-500 dark:border-l-neon-emerald"
                        >
